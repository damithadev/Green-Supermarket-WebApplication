    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto pb-1">
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
            <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white">
                ...
                <li>
                    <a href="/shop.jsp" class="block font-bold text-lg py-2 pl-3 pr-4 text-[#044A48] rounded hover:bg-gray-100 md:hover:bg-transparent md:text-blue-700 md:hover:text-blue-700 md:p-0">Shop</a>
                </li>
            </ul>
        </div>
    </div>
...
<div class="flex flex-col justify-center mb-10">
    <h1 class="font-semibold text-2xl z-10 ml-20">All Items :</h1>
</div>
                ...
                const productCard =
                                ...
                                `<div class="my-10 flex flex-col bg-gray-100 w-[18rem] border border-gray-200 rounded-3xl shadow-xl">
                                    ...
                                    <div class="-mt-14 h-56 bg-[url('/Assets/img/greenMask.svg')] bg-[center_top_-3rem] flex flex-col rounded-3xl h-48">
                                        ...
                                        <button data-modal-target="popup-modal" data-modal-toggle="popup-modal" onclick="addToCart(`+id+`)" class="mt-5 bg-[#99CC33] px-5 py-2 font-semibold text-white self-center rounded-2xl" type="button"><i class="fa fa-shopping-cart fa-lg pr-2" aria-hidden="true"></i>Add to cart</button>
                                    </div>
                                </div>`;
